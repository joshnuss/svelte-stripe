...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let email;
  $$result.css.add(css);
  return `<h1>WeChat Pay Example</h1>

<nav><a href="https://github.com/joshnuss/svelte-stripe/tree/main/src/routes/examples/wechat-pay">View code</a></nav>

${``}

<form class="svelte-4i9m9b"><input name="email" placeholder="E-mail" type="email" ${""} class="svelte-4i9m9b"${add_attribute("value", email, 0)}>

  <button ${""} class="svelte-4i9m9b">${`Pay with WeChat Pay`}</button>
</form>`;
});
export {
  Page as default
