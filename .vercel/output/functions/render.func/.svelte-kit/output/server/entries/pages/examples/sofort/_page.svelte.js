...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let name;
  $$result.css.add(css);
  return `<h1>Sofort Example</h1>

<nav><a href="https://github.com/joshnuss/svelte-stripe/tree/main/src/routes/examples/sofort">View code</a></nav>
...
<form class="svelte-4i9m9b"><input name="name" placeholder="Name" type="text" required ${""} class="svelte-4i9m9b"${add_attribute("value", name, 0)}>
  ...
  <button ${""} class="svelte-4i9m9b">${`Pay with Sofort`}</button>
</form>`;
});
export {
  Page as default
