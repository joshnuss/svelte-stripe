...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$rendered = `<h1>SEPA Example</h1>

<nav><a href="https://github.com/joshnuss/svelte-stripe/tree/main/src/routes/examples/sepa">View code</a></nav>
...
${validate_component(Elements, "Elements").$$render($$result, { stripe }, {}, {
    ...
    ${validate_component(Iban, "Iban").$$render(
          $$result,
          {
